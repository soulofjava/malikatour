                         ...
                         <li>
                             <ul>
                                 ...
                                 <li><a href="index-ai.html" class="sub-menu-item">AI Tools <span
                                             class="bg-black dark:bg-slate-50 inline-block text-white dark:text-slate-900 text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Dark</span></a>
                                 </li>
                             ...
                             <ul class="submenu">
                                 ...
                                 <li class="has-submenu child-menu-item"><a href="javascript:void(0)"> Blog Posts
                                     ...
                                     <ul class="submenu">
                                         ...
                                         <li><a href="blog-slider-post.html" class="sub-menu-item">Slider Post</a>
                                         </li>
                     ...
                     <ul class="submenu megamenu">
                         ...
                         <li>
                             <ul>
                                 ...
                                 <li><a href="portfolio- Business-four.html" class="sub-menu-item">Four Column</a>
                                 </li>
                                 <li><a href="portfolio- Business-five.html" class="sub-menu-item">Five Column</a>
                                 </li>
